...
function buildRowSessionObs(payload) {
  ...
  var row = {
    ...
    'Date': h.date || '',
    'Q1 SLs Present': c.q1 || '',
    'Q2 SL Absent Reason': Array.isArray(c.q2) ? c.q2.join(', ') : (c.q2 || ''),
    'Q3 Students Attended': Number(c.q3Attendance) || '',
    'Q4 Support SL Role': Array.isArray(c.q3) ? c.q3.join(', ') : (c.q3 || ''),
    'Q5 Teacher Involvement': Array.isArray(c.q4) ? c.q4.join(', ') : (c.q4 || ''),
    'Q6 Videos Played': c.q5 || '',
    'Q7 No Video Reason': Array.isArray(c.q6) ? c.q6.join(', ') : (c.q6 || ''),
    'Q8 Video Method': Array.isArray(c.q7) ? c.q7.join(', ') : (c.q7 || ''),
    ...
    'Q19 SL Language': Array.isArray(iif.q18) ? iif.q18.join(', ') : (iif.q18 || ''),
